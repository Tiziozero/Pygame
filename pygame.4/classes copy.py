...
class Player(pygame.sprite.Sprite):
    def __init__(self,dt, start_x, start_y, obstacle, screen):                                                #dt, starting coordinate x and y, obstacles
        super().__init__()
        #frames
    ...
    #shoots bullet
    def shoot(self, obstacle, bullets, cooldown_weapon):                                                                          #obstacle,all_sprites, bullets
